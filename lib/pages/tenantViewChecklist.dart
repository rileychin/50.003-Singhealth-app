...
class TenantViewChecklist extends StatefulWidget {
  @override
  TenantViewChecklist({
    Key key,
  ...
  @override
  _TenantViewChecklistState createState() => _TenantViewChecklistState(user,firestoreInstance);
}

class _TenantViewChecklistState extends State<TenantViewChecklist> {
  User user;
  FirebaseFirestore firestoreInstance;

  dynamic data;

  _TenantViewChecklistState(user, firestoreInstance){
    this.user = user;
