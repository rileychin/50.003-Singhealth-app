...
class StaffSubmitNonFnBAuditChecklist extends StatefulWidget {
  ...
  @override
  _StaffSubmitNonFnBAuditChecklistState createState() =>
      _StaffSubmitNonFnBAuditChecklistState(
          user, staff, tenantName, tenantReference);
}

class _StaffSubmitNonFnBAuditChecklistState
    extends State<StaffSubmitNonFnBAuditChecklist> {
  User user;
  dynamic staff;
  final firestoreInstance = FirebaseFirestore.instance;
  String tenantName;
      ...
      body: SingleChildScrollView(
          child: Align(
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    padding: const EdgeInsets.fromLTRB(100.0, 16.0, 50.0, 16.0),
                    child: Column(
                      children: <Widget>[
                        Text("Date: $todayDate"),
                        SizedBox(height: 10),
