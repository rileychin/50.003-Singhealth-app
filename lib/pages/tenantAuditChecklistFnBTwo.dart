...
class TenantAuditChecklistFnBTwo extends StatefulWidget {
  ...
  TenantAuditChecklistFnBTwo(
      {Key key, this.user, this.tenant, this.auditChecklist})
      : super(key: key);

  @override
  _TenantAuditChecklistFnBTwoState createState() =>
      _TenantAuditChecklistFnBTwoState(user, tenant, auditChecklist);
}

class _TenantAuditChecklistFnBTwoState
    extends State<TenantAuditChecklistFnBTwo> {
  User user;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text(
              '${tenant['shopName']} ${auditChecklist['date']} audit checklist'),
        ),
                    ...
                    Padding(
                      ...
                      child: Column(children: <Widget>[
                        ...
                        LabeledCheckbox(
                            ...
                            padding:
                                const EdgeInsets.symmetric(horizontal: 20.0),
                            value: auditChecklist['workplaceSafetyAndHealth']
                                [0],
                            onChanged: null),
                        LabeledCheckbox(
                            label:
