...
class StaffSubmitFnBAuditChecklist extends StatefulWidget {
  ...
  @override
  _StaffSubmitFnBAuditChecklistState createState() =>
      _StaffSubmitFnBAuditChecklistState(
          user, staff, tenantName, tenantReference);
}

class _StaffSubmitFnBAuditChecklistState
    extends State<StaffSubmitFnBAuditChecklist> {
  User user;
  dynamic staff;
  final firestoreInstance = FirebaseFirestore.instance;
  String tenantName;
            ...
            child: Align(
                ...
                child:
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.fromLTRB(100.0, 16.0, 50.0, 16.0),
                      child: Column(
                        children: <Widget>[
                          Text("Date: $todayDate"),
                          SizedBox(height: 10),
                      ...
                      child: Column(children: <Widget>[
                        ...
                        Column(
                          children: [
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[0] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                                    totalScore =
                                        (((professionalismAndStaffHygieneScore +
                                                        houseKeepingAndGeneralCleanlinessScore +
                                                        foodHygieneScore +
                                                        healthierChoiceScore +
                                                        workplaceSafetyAndHealthScore) /
                                                    96) *
                                                100)
                                            .round();
                                  });
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[6] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[7] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[8] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[9] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[10] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    professionalismAndStaffHygiene[11] =
                                        newValue;
                                    professionalismAndStaffHygieneScore =
                                        getElements(
                                            professionalismAndStaffHygiene);
                            ...
                            Padding(
                              ...
                              child: Visibility(
                                  child: Text(
                                      "Score: $professionalismAndStaffHygieneScore",
                                      style: TextStyle(
                        ...
                        Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Visibility(
                                  child: Text("General Environment Cleanliness",
                                      style: TextStyle(
                                          fontSize: 20, color: Colors.black))),
                            ),
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    ...
                                    houseKeepingAndGeneralCleanlinessScore =
                                        getElements(
                                            houseKeepingAndGeneralCleanliness);
                                    totalScore =
                                        (((professionalismAndStaffHygieneScore +
                                                        houseKeepingAndGeneralCleanlinessScore +
                                                        foodHygieneScore +
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    houseKeepingAndGeneralCleanliness[12] =
                                        newValue;
                                    houseKeepingAndGeneralCleanlinessScore =
                                        getElements(
                                            houseKeepingAndGeneralCleanliness);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    houseKeepingAndGeneralCleanliness[13] =
                                        newValue;
                                    houseKeepingAndGeneralCleanlinessScore =
                                        getElements(
                                            houseKeepingAndGeneralCleanliness);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    houseKeepingAndGeneralCleanliness[14] =
                                        newValue;
                                    houseKeepingAndGeneralCleanlinessScore =
                                        getElements(
                                            houseKeepingAndGeneralCleanliness);
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    houseKeepingAndGeneralCleanliness[15] =
                                        newValue;
                                    houseKeepingAndGeneralCleanlinessScore =
                                        getElements(
                                            houseKeepingAndGeneralCleanliness);
                            ...
                            Padding(
                              ...
                              child: Visibility(
                                  child: Text(
                                      "Score: $houseKeepingAndGeneralCleanlinessScore",
                                      style: TextStyle(
                                          fontSize: 18, color: Colors.blue))),
                            ),
                        ...
                        Column(
                          children: [
                            ...
                            LabeledCheckbox(
                                label:
                                    ("Food and non-food are clearly segregated.(	Non-food items (e.g. insecticides, detergents and other chemicals) are not stored together with the food items.)"),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 20.0),
                                value: foodHygiene[1],
                                onChanged: (bool newValue) {
                            ...
                            LabeledCheckbox(
                                label:
                                    ("Ice machine is clean and well maintained. (	Only ice is stored in the ice machine to prevent contamination of the ice.)"),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 20.0),
                                value: foodHygiene[7],
                                onChanged: (bool newValue) {
                            ...
                            LabeledCheckbox(
                                label:
                                    ("Frozen food is stored at a temperature of not more than -12°C.(	Freezer’s temperature: < -12°C)"),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 20.0),
                            ...
                            LabeledCheckbox(
                                label:
                                    ("Chilled food is stored at a temperature of not more than 4°C.(	Chiller’s temperature: 0°C ~ 4°C)"),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 20.0),
                            ...
                            Padding(
                              padding: const EdgeInsets.all(15.0),
                              child: Visibility(
                                  child: Text("Score: $foodHygieneScore",
                                      style: TextStyle(
                                          fontSize: 18, color: Colors.blue))),
                            ),
                        ...
                        Column(
                          children: [
                            ...
                            LabeledCheckbox(
                                label:
                                    ("Limit sugar content on commercially-prepared sweetened beverages.(≥ 70% commercially-prepared sweetened beverages sold to have HCS) "),
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 20.0),
                            ...
                            Padding(
                              padding: const EdgeInsets.all(15.0),
                              child: Visibility(
                                  child: Text("Score: $healthierChoiceScore",
                                      style: TextStyle(
                                          fontSize: 18, color: Colors.blue))),
                            ),
                            SizedBox(height: 10),
                        ...
                        Column(
                          children: [
                            ...
                            LabeledCheckbox(
                                ...
                                onChanged: (bool newValue) {
                                  setState(() {
                                    ...
                                    workplaceSafetyAndHealthScore =
                                        getElements(workplaceSafetyAndHealth);
                                    totalScore =
                                        (((professionalismAndStaffHygieneScore +
                                                        houseKeepingAndGeneralCleanlinessScore +
                                                        foodHygieneScore +
                            ...
                            Padding(
                              ...
                              child: Visibility(
                                  child: Text(
                                      "Score: $workplaceSafetyAndHealthScore",
                                      style: TextStyle(
                                          fontSize: 18, color: Colors.blue))),
                            ),
                          ],
  ...
  Future<void> submitChecklist() async {
    ...
    while (true) {
      DocumentSnapshot docSnap =
          await collection.doc(todayDate.toString()).get();
      if (docSnap.exists) {
        todayDate += '-2';
      } else {
        break;
    ...
    try {
      ...
      Toast.show("Successfully submitted checklist", context,
