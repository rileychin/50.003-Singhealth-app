...
class TenantAuditChecklistNonFnBTwo extends StatefulWidget {
  final User user;
  final dynamic tenant, auditChecklist;

  TenantAuditChecklistNonFnBTwo(
      {Key key, this.user, this.tenant, this.auditChecklist})
      : super(key: key);

  @override
  _TenantAuditChecklistNonFnBTwoState createState() =>
      _TenantAuditChecklistNonFnBTwoState(user, tenant, auditChecklist);
}

class _TenantAuditChecklistNonFnBTwoState
    extends State<TenantAuditChecklistNonFnBTwo> {
  User user;
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        LabeledCheckbox(
                            ...
                            value:
                                auditChecklist['professionalismAndStaffHygiene']
                                    [0],
                            onChanged: null),
                        LabeledCheckbox(
                            label:
